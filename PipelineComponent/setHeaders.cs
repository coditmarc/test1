namespace eu.codit.pipeline.httpheaders
{
    using System;
    using System.IO;
    using System.Text;
    ...
    [System.Runtime.InteropServices.Guid("4069f823-c21e-4937-8d58-cedbcc3bbff6")]
    [ComponentCategory(CategoryTypes.CATID_Encoder)]
    public class setHeaders : Microsoft.BizTalk.Component.Interop.IComponent, IBaseComponent, IPersistPropertyBag, IComponentUI
    {
        
        private System.Resources.ResourceManager _resourceManager = new System.Resources.ResourceManager("eu.codit.pipeline.httpheaders.setHeaders", Assembly.GetExecutingAssembly());
        ...
        {
            classID = new System.Guid("4069f823-c21e-4937-8d58-cedbcc3bbff6");
        }
        ...
        {
            object val = null;
            val = this.ReadPropertyBag(propertyBag, "Debug");
            if ((val != null))
            {
                this._debug = ((bool)(val));
            }
            val = this.ReadPropertyBag(propertyBag, "PropertyName");
            if ((val != null))
            {
                this._propertyName = ((string)(val));
            }
            val = this.ReadPropertyBag(propertyBag, "PropertyNameSpace");
            if ((val != null))
            {
        ...
        {
            this.WritePropertyBag(propertyBag, "Debug", this.Debug);
            this.WritePropertyBag(propertyBag, "PropertyName", this.PropertyName);
            this.WritePropertyBag(propertyBag, "PropertyNameSpace", this.PropertyNameSpace);
        }
        ...
        {
            string newHeaders = "";
            // walkthrough string that has headers (from property in namespace)
            pInMsg.Context.Write("HttpHeaders", "http://schemas.microsoft.com/BizTalk/2006/01/Adapters/WCF-properties", newHeaders);
